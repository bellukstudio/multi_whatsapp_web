...
abstract class WebViewAdapter {
  ...
  ///
  /// [accountName] is optional and purely cosmetic — only the Android
  /// native-process adapter uses it (to label its header bar to match
  /// the account being viewed); other adapters ignore it.
